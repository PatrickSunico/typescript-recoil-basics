...
export const UserListItem = memo(
  ({ id, name, age, active, profileImage, roles }: UserType) => {
    ...
    return (
      ...
      >
        ...
        <button
          className="cursor-pointer flex-none rounded-md px-2 py-[0.3125rem] font-medium text-slate-700 shadow-sm ring-1 ring-slate-700/10 hover:bg-slate-50"
  ...
  // Memo
  (prevProps: { active: boolean }, nextProps: { active: boolean }) => {
